...
Based on these simple maps it does not look like there is a strong spatial signal. Let's look at bivariate relationships between variance in abundance and geographic distance. If the relationship is positive then this would be a signal of spatial dependance.
...
# abribtarily chose the first species in sp_ids as the single variable
# predictor 
...
plot(Variogram(sing_sp_mods$Spher$nug, form = ~ x + y, maxDist = max_dist))
plot(Variogram(sing_sp_mods$Spher$nug, form = ~ x + y, resType = 'n',
               maxDist = max_dist))
